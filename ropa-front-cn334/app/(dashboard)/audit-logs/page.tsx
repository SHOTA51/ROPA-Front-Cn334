...
const auditLogs = [
  ...
  { date: '01/01/2026', time: '15:00', id: 2, name: 'Somchai Jaidee', role: 'Admin', activity: 'LOGIN', description: 'Lorem', sensitivity: 'Low' },
  { date: '01/01/2026', time: '15:00', id: 3, name: 'Somchai Jaidee', role: 'Admin', activity: 'CREATE', description: 'Lorem', sensitivity: 'Medium' },
  { date: '01/01/2026', time: '15:00', id: 4, name: 'Somchai Jaidee', role: 'Admin', activity: 'DELETE', description: 'Lorem', sensitivity: 'Medium' },
  { date: '01/01/2026', time: '15:00', id: 5, name: 'Somchai Jaidee', role: 'Admin', activity: 'CREATE', description: 'Lorem', sensitivity: 'Medium' },
  { date: '01/01/2026', time: '15:00', id: 6, name: 'Somchai Jaidee', role: 'Admin', activity: 'CREATE', description: 'Lorem', sensitivity: 'Medium' },
  { date: '01/01/2026', time: '15:00', id: 7, name: 'Somchai Jaidee', role: 'Admin', activity: 'CREATE', description: 'Lorem', sensitivity: 'Medium' },
];
